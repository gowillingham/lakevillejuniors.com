...
IF OBJECT_ID('[dbo].[vw_MailingInfoForHeadCoach]') IS NOT NULL
DROP VIEW [dbo].[vw_MailingInfoForHeadCoach]
GO

CREATE VIEW [dbo].[vw_MailingInfoForHeadCoach] AS
/***************************************************************************
	vw_MailingInfoForHeadCoach
	------------------------------------------------------------------------
	Created:2007-09-09
	RETURN(0) - success
...
/*
SELECT * FROM dbo.vw_MailingInfoForHeadCoach
*/
