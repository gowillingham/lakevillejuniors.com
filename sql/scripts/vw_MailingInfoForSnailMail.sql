...
IF OBJECT_ID('[dbo].[vw_MailingInfoForSnailMail]') IS NOT NULL
DROP VIEW [dbo].[vw_MailingInfoForSnailMail]
GO

CREATE VIEW [dbo].[vw_MailingInfoForSnailMail] AS
/***************************************************************************
	vw_MailingInfoForSnailMail
	------------------------------------------------------------------------
	Created:2007-09-09
	RETURN(0) - success
...
/*
SELECT * FROM dbo.vw_MailingInfoForSnailMail
*/
